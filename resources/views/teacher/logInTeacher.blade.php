...
<form class="max-w-sm mx-auto block" action="{{ route('teacher.auth.login') }}" method="post">
    @csrf
    ...
    <div class="my-4 hidden" id="phone">
        <div class="relative">
            ...
            <input type="text" id="phone-input" name="mobile" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0915123456"  />
    ...
    <a href="/teacher/register" class="block my-2 mr-4 text-sm text-gray-400 ">حساب ندارم / ثبت نام</a>
