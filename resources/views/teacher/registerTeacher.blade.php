...
<div class="flex justify-center h-screen ">
    <form action="{{ route('teacher.auth.register') }}" method="post" class="p-8 m-auto bg-white rounded">
        @csrf
        ...
        <div class="flex" id="email-container">
        ...
        <div class="flex" id="mobile-container">
   ...
   {{--     <div class="flex">
            ...
            <input class="input" type="text" name="ability" placeholder="مثلا پی اچ پی لاراول">
        </div>--}}
