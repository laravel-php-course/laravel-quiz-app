...
<div class="grid bg-white md:bg-gray-50 text-black p-4 grid-cols-2 border-b-2 ">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 md:text-sm text-2xs font-medium text-gray-500 md:ms-2 dark:text-gray-400">صفحه آزمون</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="col-span-1 hidden md:flex">
        <button type="button" class="text-purple-700 mr-auto hover:text-white border border-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 ">ازمون ها</button>
        <button type="button" class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 ">تماس با ما</button>
