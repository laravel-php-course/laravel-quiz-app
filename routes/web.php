...
Route::prefix('/quiz')->group(function() {
   /* GET */
    ...
    Route::get('/all/filtered', [QuizController::class, 'ShowFiltered'])->name('quiz.all.filtered');
    ...
    /* POST */
    Route::post('/add', [QuizController::class, 'Create'])->middleware(['throttle:'.config("services.throttle.time").','.config("services.throttle.minute")])
    ->name('quiz.add');
